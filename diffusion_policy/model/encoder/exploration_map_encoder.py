...
class SimpleResNet(nn.Module):
    def __init__(self, layers, img_channels=3, num_classes=1000):
...
def simple_resnet18(img_channels=3, num_classes=1000):
    return SimpleResNet([2, 2, 2, 2], img_channels, num_classes)
