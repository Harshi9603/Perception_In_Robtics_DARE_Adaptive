...
class ExplorationNodeEncoder(nn.Module):
    def __init__(self, node_dim, embedding_dim):
        super(ExplorationNodeEncoder, self).__init__()
        # dimension
    ...
    def forward(self, node_inputs, node_padding_mask, edge_mask, current_index,
        ...
        _, robot_belief_feature = self.decode_state(enhanced_node_feature, current_index, node_padding_mask)
